...
public class BoardController : MonoBehaviour
{
    ...
    //
    EventSO itemClickMoveToTrayEvent;
    EventSO autoEvent;
    EventSO endAutoEvent;
    
    private void Awake()
    {
        instance = this;
        autoEvent = Resources.Load<EventSO>(Constants.AUTO_EVENT);
        endAutoEvent = Resources.Load<EventSO>(Constants.END_AUTO_EVENT);
        autoEvent.ThingHappened += AutoMode;
        endAutoEvent.ThingHappened += EndAutoMode;
    }
    ...
    public void StartGame(GameManager gameManager, GameSettings gameSettings)
    {
        ...
        itemClickMoveToTrayEvent = Resources.Load<EventSO>(Constants.ITEM_CLICK_MOVE_TO_TRAY_EVENT);
    }
    ...
    public void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (hit.collider != null && !IsBusy)
            {
                ...
                if (cell.Item != null)
                {
                    itemClickMoveToTrayEvent.Broadcast(m_hitCollider.GetComponent<Cell>());
                }
            }
        }
